(function () {
  ...
  function repaintIfOpen() {
    ...
    if (active && active.dataset.view === 'jogar' && container && !container.querySelector('.fg-shell') && !container.querySelector('.fg-game-frame') && !container.querySelector('.fg-chat') && !container.querySelector('.fg-play') && !container.querySelector('.fg-page-card')) renderView(container);
  }
