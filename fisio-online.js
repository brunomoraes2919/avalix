(function () {
  ...
  gameStyles += '.fg-wait-player{position:relative;width:min(720px,100%);min-height:190px;gap:38px;padding:27px 34px 27px 45px;background:radial-gradient(circle at 16% 50%,rgba(54,145,124,.13),transparent 31%),linear-gradient(135deg,#fff8dc,#fff);overflow:visible}.fg-wait-photo-orbit{width:138px;height:138px;flex:0 0 138px;margin:0!important;background:transparent!important;box-shadow:none!important;font-size:inherit!important}.fg-wait-photo-orbit>.fg-duel-photo{position:relative;z-index:2;width:104px!important;height:104px!important;flex:0 0 104px;font-size:28px!important}.fg-wait-photo-orbit>b{inset:-2px;border-color:rgba(47,150,127,.32);z-index:1}.fg-wait-photo-orbit>b:nth-of-type(2){inset:-17px}.fg-wait-photo-orbit>b:nth-of-type(3){inset:-32px}.fg-wait-photo-orbit>b:after{width:11px;height:11px}.fg-wait-player>div:last-child{position:relative;z-index:2}.fg-wait-player>div:last-child>strong{max-width:480px}@media(max-width:600px){.fg-wait-player{min-height:315px;gap:30px;padding:37px 18px 24px;overflow:hidden}.fg-wait-photo-orbit{width:126px;height:126px;flex-basis:126px}.fg-wait-photo-orbit>.fg-duel-photo{width:92px!important;height:92px!important;flex-basis:92px}.fg-wait-photo-orbit>b:nth-of-type(3){inset:-25px}}';
