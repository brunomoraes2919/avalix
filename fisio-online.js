(function () {
  ...
  function answerMatch(match,state,q,answer,container){
    ...
    if(won){state.vencedor_id=current().id;state.vencedor_nome=current().nome;state.finalizada_em=new Date().toISOString();}
